...
public class FileChooserActivity extends FragmentActivity implements OnBackStackChangedListener {
	...
	public static final String EXTRA_FILTER_INCLUDE_EXTENSIONS = "com.ipaulpro.afilechooser.EXTRA_FILTER_INCLUDE_EXTENSIONS";
	...
	@SuppressLint("NewApi")
	// Usages of New APIs are surrounded by sufficient conditional checks
	@Override
	...
	private void replaceFragment(File file) {
		...
		FileListFragment fragment = FileListFragment.newInstance(mPath, mFilterIncludeExtensions);
		mFragmentManager.beginTransaction().replace(R.id.explorer_fragment, fragment).setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN)
