...
public class FileListFragment extends ListFragment implements LoaderManager.LoaderCallbacks<List<File>> {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mPath = getArguments() != null ? getArguments().getString(FileChooserActivity.PATH) : Environment.getExternalStorageDirectory()
				.getAbsolutePath();
		if (getArguments() != null) {
			mFilterIncludeExtensions = getArguments().getStringArrayList(FileChooserActivity.EXTRA_FILTER_INCLUDE_EXTENSIONS);
		}
	}
